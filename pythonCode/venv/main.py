...
whiteDressStory1 = open("textFiles/whiteDress/chatgptwhitedress1.txt", "r", encoding='utf8')
whiteDressLines1 = whiteDressStory1.read()
whiteDressStrings1 = str(whiteDressLines1)
print(whiteDressStrings1)

whiteDressStory2 = open("textFiles/whiteDress/chatgptwhitedress2.txt", "r", encoding='utf8')
whiteDressLines2 = whiteDressStory2.read()
whiteDressStrings2 = str(whiteDressLines2)
print(whiteDressStrings2)

whiteDressStory3 = open("textFiles/whiteDress/chatgptwhitedress2.txt", "r", encoding='utf8')
